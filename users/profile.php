...
<label class="col-sm-2 col-sm-2 control-label"><label class="required">Full Name</label></label>
<style>
  .required:after {
    content:" *";
    color: red;
...
<label class="col-sm-2 col-sm-2 control-label"><label class="required">User Email </label></label>
 <div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label"><label class="required">Contact</label></label>
 <div class="col-sm-4">
<input type="text" name="contactno" required="required" value="<?php echo htmlentities($row['contactNo']);?>" class="form-control">
</div>
<label class="col-sm-2 col-sm-2 control-label"><label class="required">Address </label></label>
<div class="col-sm-4">
...
<label class="col-sm-2 col-sm-2 control-label"><label class="required">Country </label></label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label"><label class="required">Pincode</label></label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label"><label class="required">User Photo</label></label>
<div class="col-sm-4">
