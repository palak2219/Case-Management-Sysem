...
<label class="col-sm-2 col-sm-2 control-label"><label class="required">Category</label></label>
<style>
  .required:after {
    content:" *";
    color: red;
...
<option value=""><label class="required">Select Category</option>
...
<label class="col-sm-2 col-sm-2 control-label"><label class="required">Sub Category </label></label>
 <div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label"><label class="required">Complaint Type</label></label>
<div class="col-sm-4">
...
<label class="col-sm-2 col-sm-2 control-label"><label class="required">Taluka</label></label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label"><label class="required">Nature of Complaint</label></label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label"><label class="required">Complaint Details (max 2000 words)</label> </label>
<div class="col-sm-6">
<textarea  name="complaindetails" required="required" cols="10" rows="10" class="form-control" maxlength="2000"></textarea>
</div>
</div>
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Complaint Related Image(if any) </label>
<div class="col-sm-6">
