 ...
 <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                      ...
                      <form class="form-horizontal style-form" method="post" name="chngpwd" onSubmit="return valid();">
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label"><label class="required">Current Password</label></label>
                              <style>
  .required:after {
    content:" *";
    color: red;
...
<div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label"><label class="required">New Password</label></label>
                              <div class="col-sm-10">
...
<div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label"><label class="required">Confirm Password</label></label>
                              <div class="col-sm-10">
